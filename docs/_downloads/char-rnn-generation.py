...
`In the last
tutorial <https://github.com/spro/practical-pytorch/blob/master/char-rnn-classification/char-rnn-classification.ipynb>`__
...
-  `Understanding LSTM
   ...
   general I also suggest the previous tutorial, `Classifying Names with
   a Character-Level
   RNN <https://github.com/spro/practical-pytorch/blob/master/char-rnn-classification/char-rnn-classification.ipynb>`__
...
# 
# *Note*: Rather than having to give it a starting letter, another
