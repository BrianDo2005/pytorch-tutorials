...
You will also find the previous tutorials on `Classifying Names with a
Character-Level
RNN <https://github.com/spro/practical-pytorch/blob/master/char-rnn-classification/char-rnn-classification.ipynb>`__
and `Generating Names with a Character-Level
RNN <https://github.com/spro/practical-pytorch/blob/master/char-rnn-generation/char-rnn-generation.ipynb>`__
